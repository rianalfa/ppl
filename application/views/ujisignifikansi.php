...
<body>
                            ...
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="col-md-12 mt-4" id="mainContainer">
                                    <div class="card">
                                        ...
                                        khususnya risetyang bermetodologi kuantitatif. 
                                        Uji ini yang akan menentukan simpulan hasil riset. 
                                        Uji signifikansi menentukan apakah hipotesis yang dibuat di awal riset akan 
    ...
    <?php $this->load->view('js/ujisignifikansi.php'); ?>
</body>
