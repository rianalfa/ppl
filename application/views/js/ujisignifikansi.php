<script>    
    ...
    function inputData() {
        ...
        request.open('POST', '<?= base_url('ujisignifikansi/inputData') ?>', true);
    ...
    function setNewHasil(hasils) {
        ...
        setNewHasilBody(tableBody, hasils['m'], 't score');

        setNewHasilBody(tableBody, hasils['mse'], 'degrees of freedom');

        setNewHasilBody(tableBody, hasils['mt'], 'one-tailed p value');

        setNewHasilBody(tableBody, hasils['mp'], 'two-tailed p value');

        setNewHasilBody(tableBody, hasils['r2'], 'mean of sample x₁');

        setNewHasilBody(tableBody, hasils['fs'], 'mean of sample x₂');

        setNewHasilBody(tableBody, hasils['fp'], 'standard deviation of x₁');

        setNewHasilBody(tableBody, hasils['hasil'], 'standard deviation of x₂');
    }
