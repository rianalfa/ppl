<script>    
        ...
        main.innerHTML = `
            <div class="card mb-2 rounded">
                <label class="ml-3 mt-2" for="uploadFile">
                    Silakan unggah file data yang akan dihitung. (File berekstensi 'xlsx' atau 'xls')
                </label>
    ...
    function setNewHasil(hasils) {
        ...
        setNewHasilBody(tableBody, hasils['cov'], 'Covariance');

        //setNewHasilBody(tableBody, hasils['r'], 'Pearson product-moment correlation coefficient');

        //setNewHasilBody(tableBody, hasils['R²'], 'Coefficient of determination');

        //setNewHasilBody(tableBody, hasils['τ'], 'Kendall rank correlation coefficient');

        //setNewHasilBody(tableBody, hasils['ρ'], 'Spearmans rank correlation coefficient');
